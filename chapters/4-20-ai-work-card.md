...
跑過一次後，可接著看 [實際填第一張 AI work card 的 walkthrough](../walkthroughs/write-an-ai-work-card.md)，再以 [五個 build gate](4-12-ready-to-build.md) 檢查是否真的準備好擴大。暫時不要把 card 直接連到外部發送、不可逆操作、客戶或私人資料、公開設定或 production 寫入。
