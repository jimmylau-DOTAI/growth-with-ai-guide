...
想先設計第一個受控試行，讀 [設計一個真的學到東西的 adoption pilot](5-6-design-adoption-pilot.md)；想把 proof card 寫成可用 template，讀 [寫一張不誇大的 value proof card](../walkthroughs/write-an-ai-value-proof-card.md)。
