...
| 想即刻寫第一張 work card | [跟住填第一張 work card](../walkthroughs/write-an-ai-work-card.md) | 一份可 review brief |
...
可返回 [AI Builder stage](../04-ai-builder.md) 看其他入口。本文以公開 agent-building 指引和 Jimmy 的工作判斷整理；它不構成資料、權限、部署、對外發送或任何 production action 的批准。
