...
想進一步設計整條 workflow 的可靠性，讀 [可靠性是 harness 問題](../chapters/4-1-harness-not-prompt.md)；想知道 feedback 怎樣變成下次更穩的判斷，讀 [把 feedback 變成判斷](../chapters/2-9-feedback-into-judgment.md)。
