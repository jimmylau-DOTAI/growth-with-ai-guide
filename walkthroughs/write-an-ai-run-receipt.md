...
要先為一條長期 workflow 定範圍，讀 [將一件重複工作寫成 AI work card](write-an-ai-work-card.md)；有多輪 receipt 後要判斷價值，讀 [為一次 AI 工作寫 value proof card](write-an-ai-value-proof-card.md)。
