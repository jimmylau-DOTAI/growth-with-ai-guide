...
要先分清「今天仍有效」和歷史過程，可讀 [新 AI 一入 project 就要翻晒 chat？你需要的是 current-state note](../chapters/3-12-current-state-not-chat-history.md)。如果 review 的是已跑過的重複工作，讀 [一條 routine 跑完，下一步改甚麼？](../chapters/3-10-routine-review.md)。
