...
| 你現在卡住的位置 | 接著讀甚麼 |
|---|---|
| 想先劃可讀／可改範圍 | [workbench contract](./4-19-唔好淨係叫人工智能做嘢.md) |
| 想安全跑一段工作 | [先跑一條可停的 Agent loop](./4-25-先跑一條可停止的智能代理循環.md) |
| 不知 prompt、Skill、automation 怎樣選 | [選最小足夠 working form](./4-8-指令技能自動化還是暫時不建立.md) |
