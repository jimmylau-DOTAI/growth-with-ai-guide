...
要先為一條長期 workflow 定範圍，讀 [將一件重複工作寫成 AI work card](./練習-第一張人工智能工作卡怎樣寫.md)；有多輪 receipt 後要判斷價值，讀 [為一次 AI 工作寫 value proof card](<../../05-AI Value Creator（AI價值創造者）/chapters/練習-人工智能有冇真價值點樣證明.md>)。
