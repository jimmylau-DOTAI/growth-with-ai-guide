...
|---|---|---|
| 不知道一件工作怎樣才算可交 AI | [答案不等於一份工作](./4-22-人工智能交出一段答案不等於它交到一份工作.md) | work unit 的完成線 |
| 想即刻寫第一張 work card | [跟住填第一張 work card](./練習-第一張人工智能工作卡怎樣寫.md) | 一份可 review brief |
| 已有好 prompt，想知道何時變 Skill | [Skill 其實是一份工作合約](./4-23-你以為技能是一段指令其實它是一份工作合約.md) | Skill 的 input、quality gate、exception |
| 想安全試第一條 loop | [先跑一條可停的 Agent loop](./4-25-先跑一條可停止的智能代理循環.md) | bounded loop 的 stop line |
