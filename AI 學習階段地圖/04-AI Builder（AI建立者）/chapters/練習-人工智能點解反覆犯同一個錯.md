...
想進一步設計整條 workflow 的可靠性，讀 [可靠性是 harness 問題](./4-1-人工智能智能代理反覆犯同一個錯唔一定係指令唔夠長.md)；想知道 feedback 怎樣變成下次更穩的判斷，讀 [把 feedback 變成判斷](<../../02-AI Super User（AI熟練使用者）/chapters/2-9-改咗十次人工智能下次仍然唔明.md>)。
