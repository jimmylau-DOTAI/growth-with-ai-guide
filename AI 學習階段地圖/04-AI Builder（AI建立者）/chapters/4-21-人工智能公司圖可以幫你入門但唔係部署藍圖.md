...
未做到這一輪低風險驗證前，暫時不要新增大量 Agent、給整個 vault 或 Drive access、連接外部發送、改 visibility 或進 production。下一步可看 [答案不等於一份工作](./4-22-人工智能交出一段答案不等於它交到一份工作.md)，再把角色圖中的一格變成真正的 AI work card。
