...
跑過一次後，可接著看 [實際填第一張 AI work card 的 walkthrough](./練習-第一張人工智能工作卡怎樣寫.md)，再以 [五個 build gate](./4-12-你唔係未識用人工智能智能代理.md) 檢查是否真的準備好擴大。暫時不要把 card 直接連到外部發送、不可逆操作、客戶或私人資料、公開設定或 production 寫入。
