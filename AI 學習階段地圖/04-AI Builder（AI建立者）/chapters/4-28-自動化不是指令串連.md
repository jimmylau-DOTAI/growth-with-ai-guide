...
| 你下一個卡位 | 接著讀甚麼 |
|---|---|
| 想把固定條件寫成 quality gate | [固定規則與 AI 判斷分工](./4-17-唔好叫人工智能猜數.md) |
| AI 同類錯不斷重演 | [Agent reliability loop](./4-24-人工智能智能代理反覆犯錯不一定要換模型.md) |
| 想安全跑第一個工作單位 | [先跑一條可停的 Agent loop](./4-25-先跑一條可停止的智能代理循環.md) |
