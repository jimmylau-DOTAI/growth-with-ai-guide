...
| 你下一個卡位 | 接著讀甚麼 | 留下甚麼 |
|---|---|---|
| 想先判斷是否應 build | [五個 build gate](./4-12-你唔係未識用人工智能智能代理.md) | build decision |
| 想把工作變成可重跑 Skill | [Skill 是工作合約](./4-23-你以為技能是一段指令其實它是一份工作合約.md) | Skill candidate |
| 想加 quality check | [Agent reliability loop](./4-24-人工智能智能代理反覆犯錯不一定要換模型.md) | rule、review、stop line |
| 想決定 loop／specialist | [Loop 還是 specialist](./4-13-你未必需要更多智能代理.md) | handoff boundary |
