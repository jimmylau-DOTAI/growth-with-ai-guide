...
|---|---|---|
| 不知資料缺口可否起稿 | [資料未齊唔等於要停](./2-12-資料未齊唔等於要停.md) | draft-ready decision |
| 想分清 evidence、解讀與 unknown | [生成前先分 evidence 和未知](./2-8-人工智能寫得好流暢點解仍然唔敢用.md) | 四欄 brief |
| 已有 first draft，想令第二稿真的較好 | [AI 第二稿 review loop](./2-11-人工智能第二稿點先真係好過第一稿.md) | revision memo |
