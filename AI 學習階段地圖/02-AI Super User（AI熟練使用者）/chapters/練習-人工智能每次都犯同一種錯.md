...
|---|---|---|
| 今次工作仍未交代清楚 | [五格組一個 AI task pack](./練習-人工智能每次都要重講背景.md) | task、材料、邊界、review |
| 不知改稿後應 pass、revise 還是 stop | [AI 第二稿 review loop](./2-11-人工智能第二稿點先真係好過第一稿.md) | revision memo |
| 想先分清 source 與自己的判斷 | [一篇 source 怎樣變成工作判斷](./練習-睇完一篇人工智能文章點先算學到.md) | source-to-decision note |
