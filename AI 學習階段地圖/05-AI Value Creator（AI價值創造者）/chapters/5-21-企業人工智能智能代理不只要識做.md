...
想先把 Agent 的工作邊界寫清，讀 [workbench contract](<../../04-AI Builder（AI建立者）/chapters/4-19-唔好淨係叫人工智能做嘢.md>)；要設計第一條可停的 Agent workflow，讀 [先跑一條可停的 Agent loop](<../../04-AI Builder（AI建立者）/chapters/4-25-先跑一條可停止的智能代理循環.md>)。
