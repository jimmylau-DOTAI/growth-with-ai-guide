...
未完成這一輪小 pilot 前，暫時不要以為 access、training 或 dashboard 已等於 transformation；亦不要讓 AI 自行外發、寫入 production、讀取私人／客戶資料或作高後果決定。下一步可看 [如何設計一條安全 adoption pilot](./5-6-想帶團隊試人工智能第一個試行要點設.md)。
