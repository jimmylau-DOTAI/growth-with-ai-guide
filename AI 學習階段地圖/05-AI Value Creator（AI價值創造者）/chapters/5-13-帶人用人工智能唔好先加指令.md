...
先從公開、低風險的 workflow 開始。未有清楚 evidence、owner 與 control 前，不要用一個好看的 demo 掩蓋 bottleneck，也不要將 AI 接到外部發送、客戶／私人資料、公開設定或 production。下一步可看 [如何由 AI Builder 走向可以服務他人的能力](./5-14-由建立人工智能走到服務.md)。
