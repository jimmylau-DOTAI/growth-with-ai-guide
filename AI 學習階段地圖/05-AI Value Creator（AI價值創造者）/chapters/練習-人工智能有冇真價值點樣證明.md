...
想先設計一條可驗收 AI 工作，讀 [將一件重複工作寫成 AI work card](<../../04-AI Builder（AI建立者）/chapters/練習-第一張人工智能工作卡怎樣寫.md>)；想記錄每一次 run 的收貨證據，讀 [AI 話做完時點樣先收貨](<../../04-AI Builder（AI建立者）/chapters/練習-人工智能完成後怎樣收貨.md>)。
